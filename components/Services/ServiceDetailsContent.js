                        ...
                        <div className="col-lg-6">
                            <div className="software-content">
                                ...
                                <ul className="features-list">
                                    <li>
                                        <span>Ahli Muda Perencana Beton Pracetak Untuk Struktur Bangunan Gedung</span>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <span>Mandor Pemasangan (Installer) Rangka Atap Baja Ringan</span>
                                    </li>
                                    <li>
                                        <span>Mandor Pemasangan Rangka Dinding dan Lantai Baja Ringan</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
